...
public class Bootcamp {
    ...
    private final LocalDate dataFinal = dataInicio.plusDays(45); //Adiciona 45 dias a data inicio do bootcamp
    private Set<Dev> devsInscritos = new HashSet<>(); // Ordem de inscrição é irrelevante
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); // A ordem dos conteúdos é importante
